...
from src.flora.privacy.differential_privacy import DifferentialPrivacyTrain


class DiffPrivacyTrainer:
    def __init__(self, args):
        ...
        if self.dataset_name == "cifar10":
            ...
            per_client_data = 50000 / self.world_size
            self.sample_rate = self.train_bsz / per_client_data
            ...
            per_client_data = 9146 / self.world_size
            self.sample_rate = self.train_bsz / per_client_data
            ...
            per_client_data = 30607 / self.world_size
            self.sample_rate = self.train_bsz / per_client_data
        ...
        self.trainer = DifferentialPrivacyTrain(
            client_id=self.rank,
            model=self.model,
            ...
            dp_gamma=args.dp_gamma,
        )

        args.hostname = socket.gethostname()
        args.optimizer = self.optimizer.__class__.__name__
        args.running_job = "DifferentialPrivacy"
