...
from src.flora.privacy.diffprivacy_train import DiffPrivacyTrainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dp-gamma", type=float, default=0.01)
    ...
    DiffPrivacyTrainer(args=args).start()
