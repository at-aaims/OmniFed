...
"""TopK encode/decode helpers for Flora ``LayerState`` gRPC messages."""
...
from src.flora.compression.sparsification import TOPK_COMPRESSION_NAME, TopKCompression
...
) -> flora_grpc_pb2.LayerState:
    layer = flora_grpc_pb2.LayerState(layer_name=name)
    t = tensor.detach().cpu()
...
def decode_layer_tensor(
    layer: flora_grpc_pb2.LayerState,
    *,
