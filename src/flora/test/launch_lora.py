...
from src.flora.test.lora_train import LoRACompressionTrain
...
if __name__ == "__main__":
    ...
    parser.add_argument("--compression-type", type=str, default="PowerSGD")
    parser.add_argument("--network-interface", type=str, default="lo0")
    parser.add_argument("--power-itr", type=int, default=4)
    parser.add_argument("--compress-rank", type=int, default=1)
    parser.add_argument("--min-compression-rate", type=int, default=2)
    ...
    LoRACompressionTrain(args=args).start()
