...
from src.flora.compression.powersgd_train import PowerSGDCompressTrain
...
class LoRACompressionTrain:
    def __init__(self, args):
        ...
        self.trainer = PowerSGDCompressTrain(
            model=self.model,
            client_id=self.rank,
