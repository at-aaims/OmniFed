...
do
  ...
  --dataset=$dataset --train-dir=$dir --test-dir=$dir --lr=$lr --gamma=$gamma --weight-decay=$weightdecay \
  --momentum=$momentum --test-bsz=$testbsz --network-interface=$interface --poly-modulus-degree=$polymoddegree &
